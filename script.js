...
c. находит сумму цифр числа n; Не получилось
...
/*Выведите с помощью цикла на экран числа от 50 до 1. Решите задачу с помощью while и for*/
...
/*Найдите сумму чисел от 1 до 50, а также сумму этих же чисел, исключая четные.*/
{
    let sum = 0;
    for(let i = 1; i <= 50; i++) {
        sum +=i;
